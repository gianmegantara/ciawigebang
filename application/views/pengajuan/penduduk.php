...
<div class="row">
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?= base_url('asset/image/Surat Keterangan Usaha.png'); ?>">
      <div class="caption">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?= base_url('asset/image/Surat Keterangan Tidak Mampu.png'); ?>">
      <div class="caption">
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?= base_url('asset/image/Surat Keterangan Domisili.png'); ?>">
      <div class="caption">
        ...
        <p>
          ...
          data-nik="<?= $penduduk->nik; ?>"
          data-nama="<?= $penduduk->nama; ?>">Ajukan</button>
          <a href="<?= base_url('asset/image/Surat Keterangan Domisili.png'); ?>" class="btn btn-default" role="button">Lihat</a>
        </p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?= base_url('asset/image/Surat Keterangan Belum Pernah Menikah.png'); ?>">
      <div class="caption">
        ...
        <p>
          ...
          data-nik="<?= $penduduk->nik; ?>"
          data-nama="<?= $penduduk->nama; ?>">Ajukan</button>
          <a href="<?= base_url('asset/image/Surat Keterangan Belum Pernah Menikah.png'); ?>" class="btn btn-default" role="button">Lihat</a>
        </p>
      </div>
    </div>
  </div>
